...
<tr>
    ...
    <td class="actions">
                    ...
                    <input type="checkbox" name="approve_req_id[]" id ="approve_req_id" value="<?php echo $row->c_request_id; ?>" ><i></i> 
                    </label> 
    </td>
    <?php } ?>
    <?php if($flg=='T') { ?>    
...
<?php }  }?>
                ...
                <?php if($flg =='A') { ?>
                <div align="center">
                <button class="btn btn-alt btn-hover btn-success" onClick="verify_status1('1');">
                <span>Approve</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                <button class="btn btn-alt btn-hover btn-danger" onClick="verify_status1('2');">
                <span>Reject</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                </div>
