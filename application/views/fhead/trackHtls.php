...
<form  id="verify_form" name="verify_form" method="post" action="<?php echo site_url(); ?>/Fhead/approve_request">
...
<tr>
   <td>
    ...
    <td class="actions">
                    ...
                    <input type="checkbox" name="approve_req_id[]" id ="approve_req_id" value="<?php echo $row->h_request_id; ?>" ><i></i> 
                    </label> 
    </td>
    <?php } ?>
    <?php if($flg=='T') { ?>    
...
<?php }  }?>
                ...
                <?php if($flg =='A') { ?>
                <div align="center">
                <button class="btn btn-alt btn-hover btn-success" onClick="verify_status1('3');">
                <span>Approve</span>
