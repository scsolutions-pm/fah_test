                    <div class="modal-header">
                        ...
                        <h3 class="modal-title custom-font"><font class="text-blue"><strong>Train Request Id : </strong>  <?php echo $t_request_id; ?></font> </h3>
                        ...
                        <p>
                            ...
                            <table border="0" > 
                                ...
                                <td style="padding : 5px;" width="350"><font class="text-darkgray"><b>Boarding State/ Drop State</b>    :    </font><font class="text-slategray">
                                       <?php echo $modal_result->state_name; ?> / <?php echo getStatName($modal_result->to_state_id); ?>
                                       </font></td> </tr>
  ...
  <tr> <td style="padding : 5px;" width="270"><font class="text-darkgray"><b>Train Class

</b>    :    </font><font class="text-slategray"><?php echo $modal_result->class_title; ?></font></td> </tr>
