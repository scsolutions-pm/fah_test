...
<tr>
    ...
    <?php if($flg =='P') { ?>
    <td class="actions">
        <a href="<?php echo site_url(); ?>/Vdol/cabVdoForm/<?php echo $row->c_request_id; ?>" data-toggle="modal" data-target="#VdoModal"><button class="btn btn-alt btn-hover btn-yellow" >
        <span>Execute</span>
