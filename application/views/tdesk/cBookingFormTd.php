                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                             <select id="cab_ctg_select" required class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                      ...
                                      <option value="<?php echo $row1->package_id;?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="outstn_city" placeholder="Enter Outstation city" class="form-control" <?php if($user_type==1 || $user_type==2){ ?>disabled="disabled"<?php } ?>  autocomplete="on" >
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                        ...
                                        <option value="0">Select Package</option>
                                        <?php if(!empty($cab_type)) { foreach($cab_type->result() as $row1) { ?>
                                        <option value="<?php echo $row1->cab_type_id; ?>"><?php echo $row1->cab_name; ?></option>
                                        <?php } } ?>
                                        </select>
                            </div>
                        </div>
...
<script type="text/javascript">
     ...
     var spl_txt_area = $('#spl_txt_area').val();
        ...
        cab_service_select:cab_service_select, c_state_select:c_state_select, c_city_select:c_city_select , outstn_city:outstn_city, c_purpose:c_purpose , flght_dtls:flght_dtls ,plycrd:plycrd, requestee:requestee
        ,traveler_name:traveler_name, traveler_email:traveler_email,traveler_mob:traveler_mob, so_no:so_no ,  btn_flg:btn_flg},
