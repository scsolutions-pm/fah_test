...
<div id="page-title">
    <h2>Chat</h2>
    <p>Create messaging systems for your web applications.</p>
...
<div class="content-box">
            ...
            <ul class="chat-box">
                <li>
                    <div class="chat-author">
                        <img width="36" src="<?php echo base_url(); ?>assets/image-resources/gravatar.jpg" alt="">
                    </div>
    ...
    <div class="button-pane pad10A">
        ...
        <div class="input-group">
            ...
            <input type="text" placeholder="Say something here..." class="form-control" id="msg">
            <div class="input-group-btn">
            	<input type="hidden" value="<?php echo $sender_id; ?>" name="sender_id" id="sender_id">
                <input type="hidden" value="<?php echo $receiver_id; ?>" name="receiver_id" id="receiver_id" >
