...
<tr>
   <td>
    ...
    <td><a href="<?php echo site_url('User/editForm/'.$row->hotel_rqst_id.'/2'); ?>" class="btn btn-xs btn-yellow" title=""> &nbsp;&nbsp;Edit&nbsp;&nbsp; </a><br><br>
    
     
    <a href="<?php echo site_url('User/generateModalCdata/'.$row->h_request_id); ?>" class="btn btn-xs btn-danger" title="">Delete</a>
    </td>
</tr>
<?php }  }?>
</tbody>
