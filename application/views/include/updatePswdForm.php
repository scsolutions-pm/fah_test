...
<div class="center-vertical">
 ...
 <h5 class="text-center pad25B font-gray text-transform-upr font-size-23"><strong><font color="#3498DB">Tr</font><font color="#E02868">av</font><font color="#75CB3C">it</font><font color="#FF5733">y</font></strong></br><span class="opacity-80" style="font-size:12px;"><strong>Smart Travel Desk</strong></span></h5>
        <form method="post" id="formpass" action="<?php echo site_url(); ?>/Home/resetPswd" id="login-validation" class="col-md-4 col-sm-5 col-xs-11 col-lg-3 center-margin" >
         <div class="content-box wow bounceInDown modal-content">
          ...
          <h3 class="content-box-header content-box-header-alt bg-default">
                        ...
                        <span class="header-wrapper">
                            Members area
                            <small>Forget / Change Password ?</small>
                        </span>
          </h3>

            <div id="login-form" class="content-box bg-default">
            <?php if(!empty($msg_email)) { ?> <font color="red"><?php echo $msg_email; ?></font> <?php } ?>
                <div class="content-box-wrapper pad20A">
                 ...
                 <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="password" id="password" required="" placeholder="Enter New Password">
                     ...
                     <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="confirmPassword" id="confirmPassword" required="" placeholder="Enter Confirm Password">
                            <span class="input-group-addon bg-blue">
                                    <i class="glyph-icon icon-unlock-alt"></i>
                            </span>
                        </div>
                   ...
                   <div class="form-group">
                        <a href="<?php echo site_url(); ?>/Home" ><button type="button" class="btn btn-danger btn-block">Back</button></a>
                    </div>
...
<!-- Online js for form validation bu saved above  -->
