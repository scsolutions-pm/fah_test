...
<tr>
   <td>
    ...
    <td><?php echo $row->train_class; ?></td>
    <?php if($flg =='A') { ?>
    <td class="actions">
                    <label class="checkbox checkbox-custom-alt">
                    <input type="checkbox" name="approve_req_id[]" id ="approve_req_id" value="<?php echo $row->t_request_id; ?>" ><i></i> 
                    </label> 
    </td>
    <?php } ?>
    <?php if($flg=='T') { ?>    
...
<?php }  }?>
                ...
                <?php if($flg =='A') { ?>
                <div align="center">
                <button class="btn btn-alt btn-hover btn-success" onClick="verify_status1('9');">
                <span>Approve</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                <button class="btn btn-alt btn-hover btn-danger" onClick="verify_status1('10');">
                <span>Reject</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                </div>
