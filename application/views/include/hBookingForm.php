               ...
               <div class="row">
                        ...
                        <div class="checkbox checkbox-primary">
                                    ...
                                    <font color="red"><strong>Is special approval required ?</strong></font>
                                        <input type="checkbox" value="checked" id="spl_app" onchange="enablePolicyHotel()" class="custom-checkbox">
                                    </label>
                                </div>
                        </div>
                            ...
                            <div id="table_booking_cab" class="bg-default content-box text-center pad20A mrg25T" 
                             <?php if( empty($request_list_hotel) || $request_list_hotel->num_rows() <= 0) { ?> style="display:none" <?php } ?>>
                                            <table class="table table-striped table-bordered dataTable">
                                                    ...
                                                    ?>
                                                    <tr class="gradeX">
                                                    <td><span class="label bg-gradient-6">
                                    ...
                                    <div class="bg-default content-box text-center pad20A mrg25T">                   
                                    <input type="submit" id="booking_btn" class="btn btn-lg btn-primary" value="Book Hotel  Now" 
