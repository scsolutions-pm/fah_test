                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="outstn_city" placeholder="Enter Outstation city" class="form-control" autocomplete="on"   <?php if(($user_type==1 && $row1->package_id==4) || ($user_type==2 && $row1->package_id==4) ){ ?>disabled=""<?php } ?>>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6" id="cab_type">
                                        ...
                                        <option value="0" id ="cab_type_id_0">Select Package</option>
                    ...
                    <input type="button" class="btn btn-lg btn-primary" onclick="addRequest('1');" value="Add Cab">
                             ...
                             <div id="table_cab" class="bg-default content-box text-center pad20A mrg25T" 
                              <?php if( empty($request_list_cab) || $request_list_cab->num_rows() <= 0) { ?> style="display:none" <?php } ?> >
													...
													<?php echo getStatName($row->state_id); ?></td> 
...
<script type="text/javascript">
  ...
  var spl_txt_area = $('#spl_txt_area').val();
	...
	if(submircheak ==1){  
        ...
        spl_app:spl_app, spl_txt_area:spl_txt_area , f_apprv:f_apprv ,so_no:so_no , btn_flg:btn_flg,booking_guest:booking_guest},
