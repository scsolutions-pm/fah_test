...
<tr>
   <td>
    ...
    <td><?php echo getStatName($row->to_state_id); ?></td>
    ...
    <td class="actions">
                    ...
                    <input type="checkbox" name="approve_req_id[]" id ="approve_req_id" value="<?php echo $row->b_request_id; ?>" ><i></i> 
                    </label> 
    </td>
    <?php } ?>
    <?php if($flg=='T') { ?>    
...
<?php }  }?>
                ...
                <?php if($flg =='A') { ?>
                <div align="center">
                <button class="btn btn-alt btn-hover btn-success" onClick="verify_status1('7');">
                <span>Approve</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                <button class="btn btn-alt btn-hover btn-danger" onClick="verify_status1('4');">
                <span>Reject</span>
                <i class="glyph-icon icon-arrow-right"></i>
                </button>
                </div>
