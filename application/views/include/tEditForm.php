<?php 
  ...
  $train_class_id = $allvalue->train_class;  
...
<div id="page-title">
    <h2> Train Request Id : <?php echo $t_request_id; ?></h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <input type="text" name="" id="b_city_boarding_t" required class="form-control" autocomplete="on" value="<?php echo $from_city_id; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <div class="input-prepend input-group">
                                    ...
                                    <input type="text" id="pick_date_t" class="bootstrap-datepicker form-control" required data-date-format="mm/dd/yy" value="<?php  echo date_format(date_create($journey_date),"m-d-Y"); ?>">
                                </div>
                         ...
                         <div class="form-group">
                            <label class="col-sm-3 control-label">Person's Age</label>
                                ...
                                <input class="form-control" type="text" value="<?php echo $person_age; ?>" id="p_age_t" name="touchspin-demo-2">
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                        ...
                                        <?php foreach($train_class_list as $train_class_types){ ?>  
                                        <option value="<?php echo $train_class_types->id; ?>" <?php if(isset($train_class_id) && $train_class_id == $train_class_types->id){ ?> selected <?php } ?>>
											<?php echo $train_class_types->class_title; ?>
                                        </option>
                                        <?php } ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                        <select name="f_apprv_t" required id="f_apprv_t" class="chosen-select form-control ">
                                    <optgroup label="Select Approver">
                                        ...
                                        <spam class="parsley-required" id="err_f_apprv_t"></spam>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="" id="b_city_drop_t" required class="form-control" autocomplete="on" value="<?php echo $to_city_id; ?>">  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="bootstrap-timepicker dropdown">
                                    <input class="timepicker-example form-control" id="pick_time_t" required type="text" value="<?php echo $from_time; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  placeholder="Optional" id="t_purpose" class="form-control" value="<?php echo $purpose;?>">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                 <input type="text" name="so_no" id="so_no_t" placeholder="Enter S/O no." class="form-control" value="<?php echo $so_no; ?>">
                ...
                <div class="col-md-6">
                            ...
                            <div class="checkbox checkbox-primary">
                                    ...
                                    <strong>Booking forGuest ?</strong>
                                        <input type="checkbox" value="checked" id="guest_app_train" onchange="enableGuestFormTrain()" class="custom-checkbox" <?php if(isset($booking_guest) && $booking_guest ==1){ ?>checked <?php } ?>>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group" id="guestEm_div_train" <?php if(isset($booking_guest) && $booking_guest !=1){ ?>style="display:none" <?php } ?>>
                            <label class="col-sm-3 control-label">Guest Emailid</label>
                            <div class="col-sm-6">
                            <input type="text" placeholder="Optional" id="traveler_email_t" class="form-control" value="<?php echo $traveler_email; ?>">
                             <spam class="parsley-required" id="err_traveler_email"></spam>  
                            </div>
                            </div>
                </div>
                <div class="col-md-6">
                             <div class="form-group"id="guestNam_div_train"  <?php if(isset($booking_guest) && $booking_guest !=1){ ?>style="display:none" <?php } ?>>
                            <label class="col-sm-3 control-label">Guest Name</label>
                            <div class="col-sm-6">
                            <input type="text" placeholder="Optional" id="traveler_name_t" class="form-control" value="<?php echo $traveler_name; ?>">
                            <spam class="parsley-required" id="err_traveler_name"></spam>
                            </div>
                            </div>

                            <div class="form-group" id="guestMo_div_train" <?php if(isset($booking_guest) && $booking_guest !=1){ ?>style="display:none" <?php } ?>>
                            <label class="col-sm-3 control-label">Guest MobileNo.</label>
                            <div class="col-sm-6">
                            <input type="text" placeholder="Optional" id="traveler_mob_t" class="form-control" value="<?php echo $person_mob_no; ?>">
                 ...
                 <div class="col-md-6">
                        ...
                        <div class="checkbox checkbox-primary">
                                    ...
                                    <font color="red"><strong>Is special approval required ?</strong></font>
                                        <input type="checkbox" value="checked" id="spl_app_train" onchange="enablePolicyTrain()" class="custom-checkbox" <?php if(isset($spl_app) && $spl_app==2){ ?>checked <?php } ?>>
                                    </label>
                                </div>
                        </div>
                  </div>       
                  <div class="col-md-6">
                        ...
                        <div class="col-sm-6">
                            <textarea name="" id="spl_txt_area_train" <?php if(isset($spl_app) && $spl_app !=2){ ?> disabled="disabled" <?php } ?> rows="3" class="form-control textarea-autosize"><?php echo $spl_app_dtls; ?></textarea>
...
<script type="text/javascript">
  ...
  //  var spl_txt_area = $('#spl_txt_area_train').val();
    ...
    else
    {
        ...
        url: '<?php echo site_url();?>/User/editSaveTrainForm',
        type: 'POST',    
        ...
        data: { 
				...
				spl_txt_area_train : spl_txt_area_train,
                ...
                btn_flg:btn_flg,edit_id:edit_id,booking_guest:booking_guest },

        success: function (htmldata2) {
			if(htmldata2.trim() == 'suces'){
						  //$('#msgss').show();
						  window.location.href = "<?php echo site_url();?>/User/editForm/<?php echo $edit_id;  ?>/4/suces";
					}
