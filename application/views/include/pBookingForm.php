 ...
 <input type="hidden"  placeholder="Enter mobile no" required class="form-control" id="cntct">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                        <select name="" required id="f_state_select" class="chosen-select form-control ">
                                    <optgroup label="Select State">
                                        <option value="0">Select State</option>
                                        <?php if(!empty($state_list)) { foreach($state_list->result() as $row1) { ?>
                                        <option value="<?php echo $row1->state_id; ?>"><?php echo $row1->state_name; ?></option>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-3 control-label">Boarding Airport</label>
                            <div class="col-sm-6">
                                <input type="text"  placeholder="Enter starting point" id="f_loc" required class="form-control">
                            </div>
                        </div>
                         <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="" required class="chosen-select form-control " id="f_city_select">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Guest Name</label>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Optional" id="traveler_f" class="form-control">
                                </div>
                            </div>


                           <div class="form-group">
                            <label class="col-sm-3 control-label">Drop Airport</label>
                            <div class="col-sm-6">
                                <input type="text"  placeholder="Enter destination point" required class="form-control" id="t_loc">
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="checkbox checkbox-primary">
                                    <label>
                                    <font color="red"><strong>Is special approval required ?</strong></font>
                                        <input type="checkbox" value="checked" id="spl_app_flight" onchange="enablePolicyFlight()" class="custom-checkbox">
                                    </label>
                                </div>
                        </div>
                        ...
                        <label class="col-sm-3 control-label">Enter details for special approval</label>
                        <div class="col-sm-6">
                            <textarea name="" id="spl_txt_area_flight" disabled="disabled" rows="3" class="form-control textarea-autosize"></textarea>
                        </div>
                        </div>
                ...
                <input type="hidden" name="booking_type" value="bt">
                <div class="row">
                             ...
                             <?php if( empty($request_list_flight) || $request_list_flight->num_rows() <= 0) { ?> style="display:none" <?php } ?>>
                                  ...
                                  <!-- Flight end -->
                                   ...
                                   <!-- <input type="submit" id="booking_btn" class="btn btn-lg btn-primary" value="Book Now" 
                                     ...
                                     <?php
if((empty($request_list_flight) || $request_list_flight->num_rows() <= 0) && 
   (empty($request_list_bus) || $request_list_bus->num_rows() <= 0) &&
   (empty($request_list_train) || $request_list_train->num_rows() <= 0) ) { ?> disabled="true" <?php } ?> >    
                                    </div>
                         </form>
                            </p>
                        </div>
