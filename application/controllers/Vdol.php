...
class Vdol extends CI_Controller
{
  ...
  public function siderbarData()
  {
      ...
      $table = 'cab_request';
      $where = array('c_status_id'=>8);
      $cab_count =  $this->Common_model->get_data($table,$where)->num_rows();

      $table = 'hotel_request';
      $where = array('h_status_id'=>8);
      $hotel_count =  $this->Common_model->get_data($table,$where)->num_rows();
...
{    
      ...
      $this->load->view('include/header',$data); 
      $this->load->view('include/sidebar',$data); 
      $this->load->view('vdo/listCabsVdo',$track_cab); 
...
{    
      ...
      $this->load->view('include/header',$data); 
      $this->load->view('include/sidebar',$data); 
      $this->load->view('vdo/listHtlsVdo',$track_htl); 
  ...
  public function cabVdoForm()
  {
    ...
    $this->load->view('modals/modalVdoCForm',$data);
  }

  public function htlVdoForm()
  {
    $data['h_request_id'] = $this->uri->segment(3);
    $this->load->view('modals/modalVdoHForm',$data);
  }
...
// print_r($cab_data);exit;
    // Email code
        ...
        $this->send_email($email_data_ROM);
    // Email code
  redirect(site_url('Vdol/pendCRqstFrm/1'));
  }
...
// print_r($cab_data);exit;
  ...
  redirect(site_url('Vdol/pendHRqstFrm/1'));
  }
